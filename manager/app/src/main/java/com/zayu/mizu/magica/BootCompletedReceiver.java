package com.zayu.mizu.magica;

import static com.zayu.mizu.magica.AppZygotePreload.TAG;
...
import com.zayu.mizu.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.zayu.mizu.magica.LAUNCH".equals(action)) {
            return;
        }
