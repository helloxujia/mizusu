package com.zayu.mizu.ui.screen.appprofile
...
import com.zayu.mizu.ui.component.AppIconImage
import com.zayu.mizu.ui.component.ListPopupDefaults
import com.zayu.mizu.ui.component.miuix.DropdownItem
import com.zayu.mizu.ui.component.profile.AppProfileConfig
import com.zayu.mizu.ui.component.profile.RootProfileConfig
import com.zayu.mizu.ui.component.profile.TemplateConfig
import com.zayu.mizu.ui.component.statustag.StatusTag
import com.zayu.mizu.ui.theme.LocalEnableBlur
import com.zayu.mizu.ui.util.BlurredBar
import com.zayu.mizu.ui.util.listAppProfileTemplates
import com.zayu.mizu.ui.util.ownerNameForUid
import com.zayu.mizu.ui.util.rememberBlurBackdrop
import com.zayu.mizu.ui.util.setSepolicy
import com.zayu.mizu.ui.viewmodel.SuperUserViewModel
                ...
                when (mode) {
                    ...
                    Mode.Template -> {
                        if (templates.isNotEmpty()) {
                            ...
                            val info = com.zayu.mizu.ui.viewmodel.getTemplateInfoById(selected)
