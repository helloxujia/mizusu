...
import com.zayu.mizu.ui.util.SulogEventType
import com.zayu.mizu.ui.util.SulogFile
import com.zayu.mizu.ui.util.toSulogDisplayName
import com.zayu.mizu.ui.viewmodel.SulogViewModel
...
fun SulogScreen() {
    ...
    when (uiMode) {
        ...
        UiMode.MizuSU -> SulogScreenMaterial(state, actions)
    }
}
