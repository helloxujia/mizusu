...
import com.zayu.mizu.ui.viewmodel.ModuleRepoViewModel
import com.zayu.mizu.ui.viewmodel.ModuleViewModel
...
fun ModuleRepoScreen() {
    ...
    when (LocalUiMode.current) {
        ...
        UiMode.MizuSU -> ModuleRepoScreenMaterial(uiState, actions)
    }
}
...
fun ModuleRepoDetailScreen(module: RepoModuleArg) {
    ...
    when (LocalUiMode.current) {
        ...
        UiMode.MizuSU -> ModuleRepoDetailScreenMaterial(state, actions)
    }
}
