...
import com.zayu.mizu.KernelVersion
import com.zayu.mizu.R
import com.zayu.mizu.ui.component.dialog.rememberConfirmDialog
import com.zayu.mizu.ui.component.miuix.WarningCard
                        ...
                        if (state.showRequireKernelWarning) {
                            WarningCard(
                                stringResource(
                                    ...
                                    state.ksuVersion ?: 0, com.zayu.mizu.Natives.MINIMAL_SUPPORTED_KERNEL
                                ),
                            )
                        }
