...
class DownloadService : Service() {
    ...
    companion object {
        ...
        const val ACTION_DOWNLOAD = "com.zayu.mizu.action.DOWNLOAD"
        const val ACTION_CANCEL = "com.zayu.mizu.action.CANCEL_DOWNLOAD"
        const val ACTION_DISMISS_DOWNLOAD = "com.zayu.mizu.action.DISMISS_DOWNLOAD"
        const val ACTION_INSTALL_MODULE = "com.zayu.mizu.action.INSTALL_MODULE"
