 ...
 */
int mizusu_super_find_struct(const char *struct_name, size_t *out_size,
                             int *out_members)
{
    for (size_t i = 0;
...
EXPORT_SYMBOL(mizusu_super_find_struct);
 ...
 */
int mizusu_super_access(const char *struct_name, const char *member_name,
...
EXPORT_SYMBOL(mizusu_super_access);
 ...
 */
int mizusu_super_container_of(const char *struct_name, const char *member_name,
...
EXPORT_SYMBOL(mizusu_super_container_of);
